...
class TFileUploadPage extends StatefulWidget {
  TFileUploadPage(this.user, this.heading, this.moduleNo, this.subject,
      {Key? key})
      : super(key: key);
  ...
  @override
  _TFileUploadPageState createState() => _TFileUploadPageState();
}

class _TFileUploadPageState extends State<TFileUploadPage> {
  Dio dio = Dio();
  ...
  Future<void> _showInputDialog() async {
    return showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Enter Textbook Details'),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              TextField(
                decoration: const InputDecoration(labelText: 'Textbook Number'),
                onChanged: (value) {
                  setState(() {
              ...
              TextField(
                decoration: const InputDecoration(labelText: 'Textbook Name'),
                onChanged: (value) {
                  setState(() {
                    _name = value;
                  });
  ...
  Future<void> _storeFileId(String fileId,type) async {
    ...
    var collection = db.collection('textbooks');
