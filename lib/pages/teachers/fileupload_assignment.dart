...
class AFileUploadPage extends StatefulWidget {
  AFileUploadPage(this.user, this.heading, this.moduleNo, this.subject,
      {Key? key})
      : super(key: key);
  ...
  @override
  _AFileUploadPage createState() => _AFileUploadPage();
}

class _AFileUploadPage extends State<AFileUploadPage> {
  Dio dio = Dio();
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              TextField(
                decoration: const InputDecoration(labelText: 'Assignment Number'),
                onChanged: (value) {
                  setState(() {
              ...
              TextField(
                decoration: const InputDecoration(labelText: 'No days to submit'),
                onChanged: (value) {
                  setState(() {
                    _due = int.tryParse(value);
                  });
                },
              ),
            ],
  ...
  Future<void> _storeFileId(String fileId) async {
    ...
    var collection = db.collection('assignment');

    var document = {
      'subjectId': widget.subject['_id'],
      'moduleNo': widget.moduleNo,
      'assignmentNo': _noteNo,
      'name': _name,
      'id': fileId,
      'submittedStudents':[],
